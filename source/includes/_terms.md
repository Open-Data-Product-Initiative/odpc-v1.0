...
| `Graph standard` | The graph standard used to implement catalog relationships through `Catalog.graph`, such as `ODPG`, `RDF`, `JSON-LD`, `GraphML`, `openCypher`, `GQL`, `Gremlin`, `GraphSON`, or `GeoSPARQL`. |
